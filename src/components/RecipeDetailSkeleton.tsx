...
export function RecipeDetailSkeleton() {
  return (
    <div className="container mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:px-8 animate-pulse">
      ...
      <Skeleton className="w-full aspect-[16/9] md:aspect-[21/9] rounded-xl mb-10 border border-border/50 bg-muted/40" />

      {/* Title and meta */}
      <Skeleton className="h-12 w-3/4 mb-4 rounded-xl bg-muted/60" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div className="md:col-span-1 space-y-4">
           ...
           <div className="space-y-4 p-8 glass rounded-xl border border-border/50 shadow-premium">
        ...
        <div className="md:col-span-2 space-y-4">
           ...
           <div className="space-y-6">
             {Array.from({length: 4}).map((_, i) => (
                <div key={i} className="space-y-3 p-8 glass rounded-xl border border-border/50 shadow-premium">
