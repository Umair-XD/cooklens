...
export function UserNav({ session }: UserNavProps) {
  ...
  return (
    <div className="relative" ref={containerRef}>
      ...
      {isOpen && (
        <div 
          className="absolute right-0 mt-2 w-64 p-2 rounded-xl bg-background shadow-premium border border-border/50 z-[100] animate-in fade-in zoom-in-95 duration-200 origin-top-right"
